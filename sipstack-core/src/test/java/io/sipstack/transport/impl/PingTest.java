...
public abstract class PingTest extends TransportLayerTestBase {
    ...
    public void testSipOptionsPing() throws Exception {
        ...
        // up the stack.
        //
        // also add a test where we are not using SIP options and then the options SHOULD be
        // passed up the stack and the FlowActor should NOT generate the 200 OK...
