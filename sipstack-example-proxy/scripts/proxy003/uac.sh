...
# Script for starting a SIPp instance using UDP
# to our proxy server and then requesting the
# second hop, the "proxied" request, to go over
# UDP as well. That is indicated by the transport parameter
...
sipp -sf uac_udp.xml -t u1 -max_socket 200 -r 1 -rsa 127.0.0.1:5060  127.0.0.1:5080
