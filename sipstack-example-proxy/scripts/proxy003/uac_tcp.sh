...
# TCP as well That is indicated by the transport parameter
# in the request-uri as you can see in the uac_xml.xml
# scenario file
...
sipp -sf uac_tcp.xml -t t1 -max_socket 200 -r 1 -rsa 127.0.0.1:5060  127.0.0.1:5080
