...
public interface Proxy {
     ...
     * your application instance should die but you still want the underlying
     ...
     * low-level transaction and/or dialog state there still may be.
     * This means that any re-transmissions for a particular transaction
     * will not be treated as a completely new request and a new
     * transaction will be created. Use this with care.
     */
    // void die();
    ...
    interface Builder {
         ...
         * is a {@link io.sipstack.netty.codec.sip.tu.ProxyBranch.Builder} that you can use
